...
const ProfileCardComponent: React.FC<ProfileCardProps> = ({
  ...
  const shineStyle = {
    ...
    backgroundImage: `repeating-linear-gradient(0deg,var(--sunpillar-clr-1) 5%,var(--sunpillar-clr-2) 10%,var(--sunpillar-clr-3) 15%,var(--sunpillar-clr-4) 20%,var(--sunpillar-clr-5) 25%,var(--sunpillar-clr-6) 30%,var(--sunpillar-clr-1) 35%),repeating-linear-gradient(-45deg,#0e152e 0%,hsl(180, 10%, 60%) 3.8%,hsl(180, 29%, 66%) 4.5%,hsl(180, 10%, 60%) 5.2%,#0e152e 10%,#0e152e 12%),radial-gradient(farthest-corner circle at var(--pointer-x) var(--pointer-y),hsla(0, 0%, 0%, 0.1) 12%,hsla(0, 0%, 0%, 0.15) 20%,hsla(0, 0%, 0%, 0.25) 120%)`.replace(
      /\s+/g,
      ' '
    ),
    gridArea: '1 / -1',
  ...
  return (
    <div
      ...
      style={
        { perspective: '500px', transform: 'translate3d(0, 0, 0.1px)', ...cardStyle } as React.CSSProperties
      }
    >
            ...
            >
              <img
                ...
                style={{
                  ...
                  borderRadius: cardRadius,
                  backfaceVisibility: 'hidden',
                  filter: 'brightness(1.0) contrast(0.95) saturate(0.9)',
                  opacity: 1,
                  zIndex: 100
                }}
                onError={e => {
              ...
              {showUserInfo && (
                <div
                  className="absolute flex items-center justify-between backdrop-blur-[30px] border border-white/20 pointer-events-auto"
                  style={
                    {
                      '--ui-inset': '20px',
                      '--ui-radius-bias': '6px',
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex flex-col items-start gap-1.5">
                      <div className="text-xs font-medium text-white leading-none" style={{ fontSize: '10px' }}>{handle}</div>
                      <div className="text-xs text-white/80 leading-none" style={{ fontSize: '10px' }}>{status}</div>
                    </div>
                  </div>

                  <button
                    className="border border-white/20 rounded-lg px-4 py-3 text-xs font-semibold text-white cursor-pointer backdrop-blur-[10px] transition-all duration-200 ease-out hover:border-white/50 hover:bg-white/10 hover:-translate-y-px"
