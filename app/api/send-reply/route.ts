  ...
  try {
    ...
    try {
      await resend.emails.send({
        from: 'CSA Prints <noreply@csaprint.com>',
        to: [to],
          ...
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
            ...
            <div style="background: #f9fafb; padding: 30px; border-radius: 0 0 10px 10px;">
              ...
              <div style="background: white; padding: 20px; border-left: 4px solid #8b5cf6; border-radius: 8px; margin: 20px 0;">
                <p style="color: #1f2937; font-size: 15px; line-height: 1.8; white-space: pre-wrap; margin: 0;">
                  ${message.replace(/\n/g, '<br>')}
                </p>
              </div>
      ...
      // Return success for database update but note email failed
      return NextResponse.json({ 
        success: true,
