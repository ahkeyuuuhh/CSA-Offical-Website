        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full px-4 py-3 bg-gray-50 border border-gray-300 rounded-lg text-gray-900 focus:border-[var(--color-cyan)] focus:ring-2 focus:ring-[var(--color-cyan)]/20 focus:outline-none transition-colors"
              ...
              <div>
                ...
                >
                  ...
                  <option value="pins">Custom Pins</option>
              ...
              <div>
                ...
                <textarea
                  ...
                  required
                  rows={5}
                  className="w-full px-4 py-3 bg-gray-50 border border-gray-300 rounded-lg text-gray-900 focus:border-[var(--color-cyan)] focus:ring-2 focus:ring-[var(--color-cyan)]/20 focus:outline-none transition-colors resize-none"
          ...
          >
              ...
              <div className="space-y-4">
                {contactInfo.map((info, index) => (
                  <motion.a
                    ...
                    className="flex items-start gap-4 p-4 bg-white border border-gray-200 rounded-xl hover:shadow-lg transition-all group"
                  >
            ...
            <motion.div
              ...
              className="aspect-video bg-gradient-to-br from-[var(--color-cyan)] via-[var(--color-magenta)] to-[var(--color-yellow)] rounded-xl shadow-lg flex items-center justify-center"
            >
